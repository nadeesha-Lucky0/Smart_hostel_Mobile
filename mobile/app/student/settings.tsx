      ...
      <Modal visible={pwdModalVisible} transparent animationType="slide">
        ...
        >
          <View style={styles.modalContent}>
            ...
            {pwdState.step === 'otp' && (
              <View style={styles.modalBody}>
                <View style={[styles.otpNotice, { backgroundColor: Colors.roles.student + '10', borderColor: Colors.roles.student + '30' }]}>
                  <Text style={[styles.otpNoticeTitle, { color: Colors.roles.student }]}>Authorization Required</Text>
                ...
                <View style={styles.modalBtnRow}>
                  ...
                  <TouchableOpacity 
                    style={[styles.modalActionBtn, { flex: 1, marginTop: 0, backgroundColor: Colors.roles.student }, pwdState.loading && styles.disabledBtn]}
            ...
            {pwdState.step === 'success' && (
              <View style={styles.successBody}>
                ...
                <TouchableOpacity 
                  style={[styles.modalActionBtn, { backgroundColor: Colors.roles.student }]}
                  onPress={() => {
                    setPwdModalVisible(false);
                    setPwdState({ step: 'form', newPwd: '', confirmPwd: '', otp: '', loading: false });
                  }}
...
const styles = StyleSheet.create({
  ...
  modalActionBtn: { backgroundColor: Colors.roles.student, padding: 18, borderRadius: 16, alignItems: 'center', marginTop: 32 },
